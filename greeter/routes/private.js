...
router.all('/:user', timelog, (req, res) => { //as is without request-transformer middleware
// router.all('/', timelog,request_transformer, (req, res) => {
    ...
    echo_response.message = "You are viewing private data"
    ...
    echo_response.id = req.params.user
